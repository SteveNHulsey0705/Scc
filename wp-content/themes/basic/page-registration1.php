<?php
/**
 * Template Name: Page registration New
 *
 *
 */
...
<script>
    jQuery().ready(function() {
		...
		var validator = jQuery("#wpcf7-f2571-o1 form.wpcf7-form").validate({
...
<div id="layout" class="pagewidth clearfix">
    ...
    <div class="form-horizontal">
		<?php  echo do_shortcode('[contact-form-7 id="2571" title="Untitled"]'); ?>
        </div>
	</div>
</div>
<!-- /layout-container -->
